...
const pillars = [
  ...
  },
  {
    ...
    text: "Žádné dlouhé pauzy mezi jízdami. Plánujeme tak, aby to sedlo vám — i o víkendu, svátcích a večer bez doplatků.",
  },
];
  ...
  return (
    <section className="mx-auto max-w-6xl px-5 py-20 sm:py-28">
      <Reveal className="max-w-2xl">
        <span className="text-sm font-semibold uppercase tracking-wider text-accent">Proč Pikoledo</span>
