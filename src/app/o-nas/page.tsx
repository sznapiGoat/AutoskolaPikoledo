    ...
    <>
      ...
      <section className="mx-auto max-w-6xl px-5 py-12">
        ...
        <Reveal className="mt-12">
          <div className="grid gap-8 overflow-hidden rounded-3xl bg-brand p-8 text-teal-50 sm:p-12 lg:grid-cols-[1.2fr_1fr] lg:items-center">
            <div>
              <h2 className="font-display text-2xl font-bold text-white sm:text-3xl">Náš příběh</h2>
              <div className="mt-4 space-y-4 text-teal-50/90">
                <p>
